...
That is enough on its own: fleqx takes its distreqx bijectors and distributions
through [parax](https://github.com/gvcallen/parax), which works with any version of
[distreqx](https://github.com/lockwo/distreqx) and supplies anything the installed
one is missing.
